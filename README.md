...
- `pnpm verify:windows`：Windows Control Plane/mock verification
- `pnpm verify:wsl`：PostgreSQL、Hatchet、OpenAdapt WSL integration
- `pnpm verify`：Phase A 全部 Windows + WSL 验证
